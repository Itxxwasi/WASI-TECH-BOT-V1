 ...
 cmd({
	...
	const daily  = await eco.daily(citel.sender, secktor, 2000); //give 500 for daily, can be changed
	 if (daily.cd) { //cdL is already formatted cooldown Left
        ...
        return await Void.sendButtonText(citel.chat, `🧧 You already claimed daily for today, come back in ${daily.cdL}🫡`, `${Config.ownername.split(' ')[0]}-Economy
Version: 0.0.6`, citel);
	 } else {
...
async(Void, citel, text,{ isCreator }) => {
    ...
    switch (value) {
        ...
        return await Void.sendButtonText(citel.chat, `*1000 🪙diamond storage has been added in ${citel.pushName} bank*`, `${Config.ownername.split(' ')[0]}-Economy
Version: 0.0.6`, citel);
        ...
        return await Void.sendButtonText(citel.chat,  `*100000 🪙diamond storage has been added in ${citel.pushName} bank*`, `${Config.ownername.split(' ')[0]}-Economy
Version: 0.0.6`, citel);
        ...
        return await Void.sendButtonText(citel.chat,  `*10000000 🪙diamond storage has been added in ${citel.pushName}\'s bank*`, `${Config.ownername.split(' ')[0]}-Economy
Version: 0.0.6`, citel);
...
async(Void, citel, text,{ isCreator }) => {
    ...
    return await Void.sendButtonText(citel.chat, `*📠 Transaction successful of ${value[0]} 💰*`, `${Config.ownername.split(' ')[0]}-Economy
Version: 0.0.6`, citel);
