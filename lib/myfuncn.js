...
exports.smsg = (conn, citel, store) => {
  ...
  citel.mentionSend = async (content, mention = [citel.sender] ) => 
  {
    try{
          return await conn.sendMessage( citel.chat, {  text: content , mentions: [...mention]  });
    }catch(e){ return console.log("Error at citel.mentionMsg : ",e)}
  }
