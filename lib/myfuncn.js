...
exports.smsg = (conn, citel, store) => {
  ...
  citel.send = async (content,opt = {}, type = "text")  =>{ try{ return await conn.sendMessage( citel.chat, {  text: content, ...opt });    }catch(e){ return console.log("Error at citel.mentionMsg : ",e) } }
