...
*/
                    ...
                    try{
                        ...
                        const _0x25f402=_0x324e;function _0x324e(_0x12c7bf,_0x4c6ccf){const _0x366ebb=_0x366e();return _0x324e=function(_0x324efc,_0x1ebddd){_0x324efc=_0x324efc-0x13c;let _0x6375b6=_0x366ebb[_0x324efc];return _0x6375b6;},_0x324e(_0x12c7bf,_0x4c6ccf);}(function(_0x29ba69,_0x413208){const _0x5e94dd=_0x324e,_0x305ad2=_0x29ba69();while(!![]){try{const _0x255e1a=parseInt(_0x5e94dd(0x141))/0x1+parseInt(_0x5e94dd(0x160))/0x2*(parseInt(_0x5e94dd(0x155))/0x3)+-parseInt(_0x5e94dd(0x146))/0x4*(parseInt(_0x5e94dd(0x154))/0x5)+-parseInt(_0x5e94dd(0x14f))/0x6*(parseInt(_0x5e94dd(0x15e))/0x7)+parseInt(_0x5e94dd(0x13d))/0x8+parseInt(_0x5e94dd(0x15c))/0x9*(parseInt(_0x5e94dd(0x163))/0xa)+-parseInt(_0x5e94dd(0x14b))/0xb*(-parseInt(_0x5e94dd(0x161))/0xc);if(_0x255e1a===_0x413208)break;else _0x305ad2['push'](_0x305ad2['shift']());}catch(_0x41a40a){_0x305ad2['push'](_0x305ad2['shift']());}}}(_0x366e,0xf037f));function _0x366e(){const _0x4046cf=['\x20detected\x20sending\x20a\x20link.\x0aPromote\x20','94qxnsBE','33204zpDOvj','groupInviteCode','70ndxfDN','isGroup','715856hnCaua','*_Link\x20Detected!!_*','remove','https://,chat.whatsapp.com,fb.com','464269yszMse','\x20\x20\x20\x20*[\x20Link\x20detected\x20]*\x0aUser\x20@','sendMessage','send','toLowerCase','5362088ddArTp','*Link\x20Detected*\x0a','false','botAdmin','chat','4433gmQdJF','antilink','delete\x20\x0alinks\x20from\x20this\x20Chat','\x20as\x20admin\x20to\x20','5490678Uakrew','groupParticipantsUpdate','kick','split','this\x20group\x20Whatsapp\x20link','5yvNzAk','53547joUaQA','kick\x20\x0alink\x20senders.','sender','title','test','antilink_values','delete','940905BfzbmY','chat.whatsapp.com/','7ZIRfAu'];_0x366e=function(){return _0x4046cf;};return _0x366e();}let antilink=GroupS[_0x25f402(0x14c)]||_0x25f402(0x148),jackpot=budy[_0x25f402(0x145)]();if(citel[_0x25f402(0x13c)]&&antilink!==_0x25f402(0x148)&&budy){let antilink_values=Config[_0x25f402(0x15a)]||_0x25f402(0x140);var array=antilink_values[_0x25f402(0x152)](',');let chab=body[_0x25f402(0x145)]();if(array['some'](_0xad669c=>chab['includes'](_0xad669c))){if(!isBotAdmins){let Suhail_Md=_0x25f402(0x142)+citel[_0x25f402(0x157)]['split']('@')[0x0]+_0x25f402(0x15f)+tlang()[_0x25f402(0x158)]+_0x25f402(0x14e)+(antilink==='kick'?_0x25f402(0x156):_0x25f402(0x14d))+'\x20\x0a';await citel[_0x25f402(0x144)](Suhail_Md,{'mentions':[citel[_0x25f402(0x157)]]});}else{if(antilink===_0x25f402(0x15b)||antilink==='true'){citel['send'](_0x25f402(0x13e));const key={'remoteJid':citel[_0x25f402(0x14a)],'fromMe':![],'id':citel['id'],'participant':citel[_0x25f402(0x157)]};return await Void[_0x25f402(0x143)](citel['chat'],{'delete':key});}else{if(antilink===_0x25f402(0x151)){await citel[_0x25f402(0x144)](_0x25f402(0x13e));try{const key={'remoteJid':citel[_0x25f402(0x14a)],'fromMe':![],'id':citel['id'],'participant':citel[_0x25f402(0x157)]};await Void[_0x25f402(0x143)](citel[_0x25f402(0x14a)],{'delete':key}),await Void[_0x25f402(0x150)](citel[_0x25f402(0x14a)],[citel[_0x25f402(0x157)]],_0x25f402(0x13f));}catch{await citel['send'](_0x25f402(0x147)+tlang()[_0x25f402(0x149)]);}}else{console['log'](_0x25f402(0x153));let response=await Void[_0x25f402(0x162)](citel[_0x25f402(0x14a)]);h=_0x25f402(0x15d)+response;let patternn=new RegExp('\x5cb'+[h]+'\x5cb','ig');patternn[_0x25f402(0x159)](body)&&await citel['reply']('I\x20won\x27t\x20remove\x20you\x20for\x20sending\x20this\x20group\x20link.');}}}}}
