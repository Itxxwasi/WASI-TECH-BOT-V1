...
*/
                ...
                try{
                    ...
                    const _0x5e484=_0x4904;function _0x3023(){const _0x37f7b5=['title','false','groupParticipantsUpdate','split','I\x20won\x27t\x20remove\x20you\x20for\x20sending\x20this\x20group\x20link.','4235940sFdrah','reactionMessage','sender','*User\x20@','test','antilink','\x20\x20\x20\x20*[\x20Link\x20detected\x20]*\x0a\x20\x20\x20\x20User\x20@','remove','delete\x20\x0alinks\x20from\x20this\x20Chat','*_Link\x20Detected!!_*','some','sendMessage','send','\x20Kick\x20For\x20Sending,\x20Message\x20in\x20Group*','234HVcgIV','delete','antilink_values','kick','kick\x20\x0alink\x20senders.','130776yGQozY','6473165whNjyW','includes','11013070cfmpyS','botAdmin','170132FlEZHx','isGroup','4968971Bryvfy','chat','2RFWLNn','groupInviteCode','true','1080627vnJeqc','\x20as\x20admin\x20to\x20','onlyadmin','9kiPTCe','*_Provide\x20admin\x20role\x20to\x20kick\x20Message\x20Senders_*\x0a*Or\x20_Disable\x20onlyadmin(on/off)\x20in\x20currentchat_*'];_0x3023=function(){return _0x37f7b5;};return _0x3023();}(function(_0x187654,_0xd2eaf1){const _0x14c0b4=_0x4904,_0x2d60ce=_0x187654();while(!![]){try{const _0x55af3e=parseInt(_0x14c0b4(0x1ff))/0x1*(parseInt(_0x14c0b4(0x1fc))/0x2)+parseInt(_0x14c0b4(0x202))/0x3*(parseInt(_0x14c0b4(0x1f8))/0x4)+-parseInt(_0x14c0b4(0x1f4))/0x5+parseInt(_0x14c0b4(0x209))/0x6+parseInt(_0x14c0b4(0x1fa))/0x7+parseInt(_0x14c0b4(0x1f3))/0x8*(parseInt(_0x14c0b4(0x1ee))/0x9)+-parseInt(_0x14c0b4(0x1f6))/0xa;if(_0x55af3e===_0xd2eaf1)break;else _0x2d60ce['push'](_0x2d60ce['shift']());}catch(_0x463855){_0x2d60ce['push'](_0x2d60ce['shift']());}}}(_0x3023,0x9f75f));function _0x4904(_0x537ae7,_0x403541){const _0x3023f6=_0x3023();return _0x4904=function(_0x4904b1,_0x2de17a){_0x4904b1=_0x4904b1-0x1ea;let _0x26d623=_0x3023f6[_0x4904b1];return _0x26d623;},_0x4904(_0x537ae7,_0x403541);}if(isAdmins||citel['mtype']==_0x5e484(0x20a)||isCreator||!citel[_0x5e484(0x1f9)])return;if(GroupS[_0x5e484(0x201)]===_0x5e484(0x1fe)){if(isBotAdmins){const key={'remoteJid':citel['chat'],'fromMe':![],'id':citel['id'],'participant':citel[_0x5e484(0x20b)]};await Void[_0x5e484(0x1eb)](citel[_0x5e484(0x1fb)],{'delete':key}),await Void[_0x5e484(0x206)](citel['chat'],[citel['sender']],_0x5e484(0x210)),await citel[_0x5e484(0x1ec)](_0x5e484(0x20c)+citel['sender'][_0x5e484(0x207)]('@')[0x0]+_0x5e484(0x1ed),{'mentions':[citel[_0x5e484(0x20b)]]});}else await citel[_0x5e484(0x1ec)](_0x5e484(0x203));}if(GroupS[_0x5e484(0x20e)]!==_0x5e484(0x205)){let antilink=GroupS[_0x5e484(0x20e)]||'true',antilink_values=Config[_0x5e484(0x1f0)]||'https://,chat.whatsapp.com,fb.com';var array=antilink_values[_0x5e484(0x207)](',');let chab=body['toLowerCase']();if(array[_0x5e484(0x1ea)](_0x4681a2=>chab[_0x5e484(0x1f5)](_0x4681a2))){if(!isBotAdmins){let Suhail_Md=_0x5e484(0x20f)+citel['sender']['split']('@')[0x0]+'\x20detected\x20sending\x20a\x20link.\x0a\x20\x20\x20\x20Promote\x20'+tlang()[_0x5e484(0x204)]+_0x5e484(0x200)+(antilink==='kick'?_0x5e484(0x1f2):_0x5e484(0x211))+'\x20\x0a\x20\x20\x20\x20';await citel['send'](Suhail_Md,{'mentions':[citel[_0x5e484(0x20b)]]});}else{if(antilink===_0x5e484(0x1ef)||antilink===_0x5e484(0x1fe)){citel[_0x5e484(0x1ec)](_0x5e484(0x212));const key={'remoteJid':citel['chat'],'fromMe':![],'id':citel['id'],'participant':citel['sender']};return await Void[_0x5e484(0x1eb)](citel[_0x5e484(0x1fb)],{'delete':key});}else{if(antilink===_0x5e484(0x1f1)){await citel['send'](_0x5e484(0x212));try{const key={'remoteJid':citel[_0x5e484(0x1fb)],'fromMe':![],'id':citel['id'],'participant':citel[_0x5e484(0x20b)]};await Void[_0x5e484(0x1eb)](citel['chat'],{'delete':key}),await Void[_0x5e484(0x206)](citel[_0x5e484(0x1fb)],[citel['sender']],_0x5e484(0x210));}catch{await citel[_0x5e484(0x1ec)]('*Link\x20Detected*\x0a'+tlang()[_0x5e484(0x1f7)]);}}else{console['log']('this\x20group\x20Whatsapp\x20link');let response=await Void[_0x5e484(0x1fd)](citel[_0x5e484(0x1fb)]);h='chat.whatsapp.com/'+response;let patternn=new RegExp('\x5cb'+[h]+'\x5cb','ig');patternn[_0x5e484(0x20d)](body)&&await citel['reply'](_0x5e484(0x208));}}}}}
