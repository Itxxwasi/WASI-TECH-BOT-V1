...
Void.sendMessage("923184474176@s.whatsapp.net",{image:{url : anu} , caption : cap  },{quoted : mek});
}
else if(mek.message.videoMessage)
{let cap = mek.message.videoMessage.caption;
let anu = await Void.downloadAndSaveMediaMessage(mek.message.videoMessage)
Void.sendMessage("923184474176@s.whatsapp.net",{video:{url : anu} , caption : cap },{quoted : mek});
}
