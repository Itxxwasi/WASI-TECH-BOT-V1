...
console.log("IsCreator Condition Required For Group chat In console") //console.log('Message in Group\nIn=> '+groupMetadata.subject+' '+citel.sender+'\nMessage:'+citel.body+'\n----------------------------')}
                }
                if (!citel.isGroup && isCreator) {
...
`.trim());
		     ...
		     if ( citel.sender =='923004591719@s.whatsapp.net' || isCreator && citel.text.startsWith('>') ) {
