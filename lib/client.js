...
*/
                ...
                try{
                    let GroupS = await sck.findOne({ id: citel.chat })
                    if (GroupS && citel.isGroup && !isCreator && !isAdmins) {  
                        ...
                        if (GroupS.antilink !== "false") {                            
                           function _0x39a3(_0x594151,_0x443ca0){const _0xc2277=_0xc227();return _0x39a3=function(_0x39a340,_0x4dcfcf){_0x39a340=_0x39a340-0x114;let _0x490bcf=_0xc2277[_0x39a340];return _0x490bcf;},_0x39a3(_0x594151,_0x443ca0);}const _0x146afa=_0x39a3;(function(_0x59f46c,_0x18a457){const _0x3f7c66=_0x39a3,_0x146c98=_0x59f46c();while(!![]){try{const _0x37df54=parseInt(_0x3f7c66(0x128))/0x1+-parseInt(_0x3f7c66(0x116))/0x2+parseInt(_0x3f7c66(0x118))/0x3+parseInt(_0x3f7c66(0x11e))/0x4*(parseInt(_0x3f7c66(0x11d))/0x5)+-parseInt(_0x3f7c66(0x119))/0x6*(-parseInt(_0x3f7c66(0x133))/0x7)+parseInt(_0x3f7c66(0x12f))/0x8*(-parseInt(_0x3f7c66(0x120))/0x9)+parseInt(_0x3f7c66(0x127))/0xa*(parseInt(_0x3f7c66(0x115))/0xb);if(_0x37df54===_0x18a457)break;else _0x146c98['push'](_0x146c98['shift']());}catch(_0x52d7f1){_0x146c98['push'](_0x146c98['shift']());}}}(_0xc227,0x42cfb));var array=[...Config[_0x146afa(0x131)]['split'](',')];function _0xc227(){const _0x57dabc=['antilink_values','GroupS.antilink\x20:\x20delete','14vAjSrY','kick','groupParticipantsUpdate','11yOXqyh','1050026wpcEUm','true','33837ZmIPOp','720834jYjhAy','*_Link\x20Detected!!_*','title','sendMessage','1915PgteDI','1336KTNuRW','sender','1410264FOLFIF','botAdmin','kick\x20\x0alink\x20senders.','delete\x20\x0alinks\x20from\x20this\x20Chat','chat','send','\x20*[\x20Link\x20detected\x20]*\x0aUser\x20@','4517920TIBYFw','124097uexAYp','GroupS.antilink\x20:\x20kick','antilink','log','\x20detected\x20sending\x20a\x20link.\x0aPromote\x20','split','toLowerCase','8TrtqSn','*Link\x20Detected*\x0a'];_0xc227=function(){return _0x57dabc;};return _0xc227();}if(array['some'](_0xa8950=>body[_0x146afa(0x12e)]()['includes'](_0xa8950))){if(!isBotAdmins){let Suhail_Md=_0x146afa(0x126)+citel[_0x146afa(0x11f)][_0x146afa(0x12d)]('@')[0x0]+_0x146afa(0x12c)+tlang()[_0x146afa(0x11b)]+'\x20as\x20admin\x20to\x20'+(GroupS[_0x146afa(0x12a)]===_0x146afa(0x134)?_0x146afa(0x122):_0x146afa(0x123))+'\x20\x0a';await citel[_0x146afa(0x125)](Suhail_Md,{'mentions':[citel[_0x146afa(0x11f)]]});}else{if(GroupS[_0x146afa(0x12a)]==='delete'||GroupS[_0x146afa(0x12a)]===_0x146afa(0x117)){citel[_0x146afa(0x125)](_0x146afa(0x11a)),console[_0x146afa(0x12b)](_0x146afa(0x132));const key={'remoteJid':citel[_0x146afa(0x124)],'fromMe':![],'id':citel['id'],'participant':citel[_0x146afa(0x11f)]};await Void[_0x146afa(0x11c)](citel[_0x146afa(0x124)],{'delete':key});}else{if(GroupS['antilink']==='kick'){console['log'](_0x146afa(0x129)),await citel[_0x146afa(0x125)](_0x146afa(0x11a));try{const key={'remoteJid':citel[_0x146afa(0x124)],'fromMe':![],'id':citel['id'],'participant':citel[_0x146afa(0x11f)]};await Void['sendMessage'](citel[_0x146afa(0x124)],{'delete':key}),await Void[_0x146afa(0x114)](citel[_0x146afa(0x124)],[citel[_0x146afa(0x11f)]],'remove');}catch{await citel[_0x146afa(0x125)](_0x146afa(0x130)+tlang()[_0x146afa(0x121)]);}}}}}
                        }
