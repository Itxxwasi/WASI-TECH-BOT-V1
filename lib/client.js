...
setInterval(() => {
	...
	if(mek.message.videoMessage)
		...
		const blockJid = [...global.blockJids].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net");
                const quoted = citel.quoted ? citel.quoted : citel;
                const mime = (quoted.msg || quoted).mimetype || "";
                if (citel.chat === blockJid) return citel.reply("Jid Blocked...Bot Not Works Here")
