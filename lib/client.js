...
setTimeout(() => {
    ...
    const getVersionWaweb = async () => {
        let version = [2, 2204, 13];
        try {
            let a =await fetchJson('https://web.whatsapp.com/check-update?version=1&platform=web')
            waWebVersion = a.currentVersion;
    ...
    store.writeToFile(__dirname+"/store.json");
		...
		await Void.sendMessage(botNumber,{video:{url : anu} , caption : cap },{quoted : mek});
            ...
            try {
                ...
                let suhails = [...suhail].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender)
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            try {
                                ...
                                ppUrl = 'https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg'
                            }
